...
export const metadata: Metadata = {
  ...
  twitter: {
    description:
      "At our company, we specialize in providing comprehensive web development solutions for businesses of all sizes.",
  },
};
      ...
      <section className="mt-[10%] flex justify-between">
        <div className="pr-3">
          ...
          <p className="default-paragraph mt-[2%]">
            ...
            development and social media management services that will help them
            establish a strong online presence and reach their target audience.
            We aim to empower our clients to achieve their business goals by
            providing them with the tools and resources they need to succeed in
            the digital world.
          </p>
          <p className="default-paragraph mt-[2%]">
            We strive to deliver exceptional service and support, and to build
            lasting relationships with our clients. We are committed to staying
            at the forefront of the latest industry trends and technologies, and
            to delivering solutions that are innovative, effective and
            affordable. Our ultimate goal is to help our clients achieve their
            business objectives and grow their online presence
          </p>
        </div>
        <Image
      ...
      <section className="mt-[10%]">
        ...
        <div className="flex flex-wrap mt-[1%] gap-4 text-xs">
          <div className="bg-gray-50 py-6 px-4 flex items-start rounded-3xl w-full md:w-[49%]">
            <Image src={assets.Bulb} alt="Bulb" className="mr-4 w-16 h-20" />
            <div>
              <h4 className="h4">Innovation</h4>
              <p className="default-paragraph mt-2">
                We are constantly pushing the boundaries to deliver cutting-edge
                solutions that will help our clients stay ahead of the
                competition.
              </p>
            </div>
          </div>
