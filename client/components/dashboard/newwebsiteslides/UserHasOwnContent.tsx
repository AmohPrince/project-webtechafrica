...
const UserHasOwnContent = ({
  ...
  return (
    <div className="bg-white p-6">
      ...
      <div className="md:flex justify-between md:justify-start items-center my-5">
      ...
      <SecondaryButton
        ...
        className="outline-none hover:scale-100 transition-all ml-auto w-full md:w-auto mt-5 md:mt-0"
