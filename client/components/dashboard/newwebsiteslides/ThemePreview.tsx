...
const ThemePreview = ({ theme }: { theme: Theme }) => {
  return (
    ...
    >
      ...
      <h1 className="text-center mt-14 playfair text-3xl md:text-5xl">
        Discover <span style={{ color: theme.colors.primary }}>Luxury</span> and
        Elegance with Louis{" "}
        <span style={{ color: theme.colors.primary }}>Vuitton</span>
      </h1>
      <div className="flex items-center mt-6 justify-center flex-col md:flex-row">
        <p className="mr-4 text-gray-500">29 Apr 2020. FASHION, DESIGN</p>
        <p
          className="text-xs py-3 px-2 rounded-sm text-white mt-3 md:mt-0"
          style={{ backgroundColor: theme.colors.primary }}
        >
          View Demo
        </p>
      </div>
      <p className="w-2/3 md:w-1/2 mx-auto text-center mt-5">
